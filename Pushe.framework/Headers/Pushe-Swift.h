...
SWIFT_CLASS("_TtC5Pushe5Pushe")
@interface Pushe : NSObject <GGLInstanceIDDelegate, GCMReceiverDelegate, UNUserNotificationCenterDelegate>
...
@interface UIDevice (SWIFT_EXTENSION(Pushe))
